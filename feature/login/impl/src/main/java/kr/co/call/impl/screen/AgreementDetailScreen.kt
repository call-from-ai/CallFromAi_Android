...
import kr.co.call.impl.component.AgreementMarkdownText
    ...
    CallFromAiTheme {
        AgreementDetailScreen(
            ...
            content = """
                ...
                채팅 내용, 음성 변환 텍스트, AI 응답 내용, 서비스 이용 기록 등을 활용할 수 있습니다.

                필요한 경우 개인을 직접 식별할 수 있는 정보는 제거하거나 가명 처리합니다.

                ## 3. 보유 및 이용 기간

                동의 철회 또는 회원 탈퇴 시까지 보유·이용합니다.

                다만 관련 법령에 따라 보관이 필요한 경우에는 정해진 기간 동안 보관할 수 있습니다.

                ## 4. 동의 거부 및 철회

                본 동의는 선택 사항이며, 동의하지 않아도 전화왔어의 기본 서비스를 이용할 수 있습니다.

                - 회원은 언제든지 동의를 철회할 수 있습니다.
                - 설정 또는 고객센터를 통해 철회할 수 있습니다.
