...
fun CallGradientBackground(
    ...
    val colors = CallTheme.colors
    val gradientBlobs = remember(colors) {
        listOf(
            GradientBlob(
                startColor = colors.callGradientAccent,
                widthRatio = 2.1650f,
                heightRatio = 1.0632f,
                leftRatio = -0.0485f,
                topRatio = 0.3511f,
            ...
            GradientBlob(
                startColor = colors.callGradientPeach.copy(alpha = 0.9f),
                widthRatio = 2.0364f,
                heightRatio = 1.1363f,
                leftRatio = 0.2427f,
                topRatio = 0f,
            ...
            GradientBlob(
                startColor = colors.callGradientPeach.copy(alpha = 0.6f),
                widthRatio = 2.1650f,
                heightRatio = 1.1363f,
                leftRatio = 0.1942f,
                topRatio = 0.7797f,
    ...
    val gradientEndColor = colors.callGradientFade.copy(alpha = 0f)
